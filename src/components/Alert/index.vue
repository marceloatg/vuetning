<!--
    @Description: Use the offline alert to let the user know that they are not connected to the internet.
    @Documentation: https://www.lightningdesignsystem.com/components/alert/
-->
