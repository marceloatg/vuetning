...
import SldsCheckboxGroup from "./slds-checkbox-group.vue"
...
describe("SldsCheckboxGroup", () => {
    it("renders one checkbox per option", () => {
        const wrapper = mount(SldsCheckboxGroup, {
    ...
    it("emits update:modelValue with the toggled value when an option is clicked", async () => {
        const wrapper = mount(SldsCheckboxGroup, {
            props: { label: "Picks", options: OPTIONS, modelValue: [] },
        })
    ...
    it("does not emit when the group is disabled and an option is clicked", async () => {
        const wrapper: any = mount(SldsCheckboxGroup, {
            props: { label: "Picks", options: OPTIONS, modelValue: [], disabled: true },
        })
