...
<script>
import SldsScopedTab from '@/components/slds-scoped-tabs/slds-scoped-tab'
import SldsScopedTabContent from '@/components/slds-scoped-tabs/slds-scoped-tab-content'
