<template>
    ...
    <g v-else-if="id === 'audio'" fill-rule="evenodd" clip-rule="evenodd">
        <path
            ...
            fill="#0D9DDA"
        />
        <path d="M56 20.357v1H43.2s-6.312-1.26-6.128-6.707c0 0 .208 5.707 6.003 5.707H56z" fill="#05628A"/>
        <path d="M37.097.006v14.561c0 1.656 1.104 5.791 6.104 5.791h12.8L37.097.006z" fill="#90D0FE"/>
        <path
    ...
    <g v-else-if="id === 'box_notes'">
        ...
        />
        <path fill="#024D4C" d="M55.96 20.377v1H43.161s-6.312-1.26-6.129-6.707c0 0 .208 5.707 6.004 5.707H55.96z"/>
        <path fill="#ACF3E4" d="M37.059.025v14.561c0 1.656 1.104 5.791 6.104 5.791h12.799L37.059.025z"/>
        <path
            fill="#FFF"
    ...
    <g v-else-if="id === 'eps'">
        ...
        <g fill-rule="evenodd" clip-rule="evenodd">
            <path
                ...
                fill="#E4A201"
            />
            <path d="M37.097.006v14.561c0 1.656 1.104 5.791 6.104 5.791H56L37.097.006z" fill="#F9E3B6"/>
        </g>
    </g>

    <g v-else-if="id === 'excel'">
        <path
    ...
    <g v-else-if="id === 'exe'">
        ...
        <g fill-rule="evenodd" clip-rule="evenodd">
            <path
                ...
                fill="#5C5C5C"
            />
            <path d="M37.059.025v14.561c0 1.656 1.104 5.792 6.104 5.792h12.799L37.059.025z" fill="#C9C9C9"/>
        </g>
        <path
    ...
    <g v-else-if="id === 'flash'">
        ...
        <g fill-rule="evenodd" clip-rule="evenodd">
            <path
                ...
                fill="#BA0517"
            />
            <path d="M37.059-.006v14.561c0 1.656 1.104 5.791 6.104 5.791h12.799L37.059-.006z" fill="#FE8F7D"/>
        </g>
        <path
    ...
    <g v-else-if="id === 'gsheet'">
        ...
        />
        <g fill-rule="evenodd" clip-rule="evenodd">
            <path d="M55.98 20.32v1H43.179s-6.312-1.26-6.127-6.707c0 0 .207 5.707 6.002 5.707H55.98z" fill="#22683E"/>
            <path d="M37.076-.031V14.53c0 1.656 1.104 5.791 6.104 5.791h12.801L37.076-.031z" fill="#CDEFC4"/>
        </g>
    </g>
    ...
    <g v-else-if="id === 'html'">
        ...
        <g fill-rule="evenodd" clip-rule="evenodd">
            <path
                ...
                fill="#D83A00"
            />
            <path d="M37.074 0v14.561c0 1.656 1.104 5.791 6.104 5.791h12.799L37.074 0z" fill="#FEB9A5"/>
        </g>
        <path
    ...
    <g v-else-if="id === 'keynote'">
        ...
        <g fill-rule="evenodd" clip-rule="evenodd">
            <path
                ...
                fill="#A96404"
            />
            <path d="M37.074 0v14.561c0 1.656 1.104 5.791 6.104 5.791h12.799L37.074 0z" fill="#FFBA90"/>
        </g>
        <path
    ...
    <g v-else-if="id === 'library_folder'">
        ...
        />
        <g fill="#FFF">
            <path d="M25.5 37.8h3.6v11.5h-3.6zM31.6 37.8h3.6v11.5h-3.6z"/>
            <path
    ...
    <g v-else-if="id === 'mp4'">
        <g fill-rule="evenodd" clip-rule="evenodd">
            <path
                d="M5.116.006A5.073 5.073 0 00.044 5.08v53.841a5.073 5.073 0 005.072 5.074h45.775a5.074 5.074 0 005.074-5.074V20.316L37.062.006H5.116z"
                fill="#730394"
            />
            <path
                d="M55.977 20.352v1H43.178s-6.312-1.26-6.129-6.707c0 0 .208 5.707 6.004 5.707h12.924z"
    ...
    <g v-else-if="id === 'overlay'">
        ...
        <path d="M10.123 34.515v14.081h14.694V34.515H10.123zm5.344 5.343v14.081h14.694V39.858H15.467z" fill="#fff"/>
    ...
    <g v-else-if="id === 'pages'">
        ...
        <g fill-rule="evenodd" clip-rule="evenodd">
            <path
                ...
                fill="#2F2CB7"
            />
            <path d="M37.074 0v14.561c0 1.656 1.104 5.791 6.104 5.791h12.799L37.074 0z" fill="#BEC7F6"/>
        </g>
        <path
    ...
    <g v-else-if="id === 'pdf'">
        <path
            ...
            d="M5.1 0C2.3 0 0 2.3 0 5.1v53.8C0 61.7 2.3 64 5.1 64h45.8c2.8 0 5.1-2.3 5.1-5.1V20.3L37.1 0h-32z"
        />
        <path fill="#640103" d="M56 20.4v1H43.2s-6.3-1.3-6.1-6.7c0 0 .2 5.7 6 5.7H56z"/>
        <path fill="#FEB8AB" d="M37.1 0v14.6c0 1.7 1.1 5.8 6.1 5.8H56L37.1 0z"/>
        <path
            fill="#FFF"
    ...
    <g v-else-if="id === 'quip_doc'">
        ...
        />
        <path fill="#AACBFF" d="M37 0l19 21H42.1c-2.8 0-5.2-2.3-5.2-5.2L37 0z"/>
        <path fill="#014486" d="M37 15.9v1c0 2.8 2.3 5.2 5.2 5.2H56v-1H42.1c-2.8-.1-5.1-2.4-5.1-5.2z"/>
        <path
            fill="#FFF"
        ...
        <path
            fill="#FFF"
            d="M26.8 36.7c-3.9-3.7-10.1-3.6-13.9.2-3.8 3.8-3.9 10-.2 13.9 1.9 2 4.5 3.2 7.3 3.2h9.2c.4 0 .8-.3.8-.8V44c0-2.8-1.1-5.4-3.2-7.3zm1.6 15.8H20c-2.3 0-4.6-1-6.2-2.7-1.6-1.7-2.4-4-2.3-6.3.3-4.3 3.7-7.7 7.9-7.9h.5c4.7 0 8.5 3.8 8.5 8.5v8.4z"
        />
    </g>

    <g v-else-if="id === 'quip_sheet'">
        <path
            fill-rule="evenodd"
            clip-rule="evenodd"
            fill="#3BA755"
            d="M0 5.1v53.7C0 61.7 2.3 64 5.1 64h45.7c2.8 0 5.1-2.3 5.1-5.1V21L37 0H5.1C2.3 0 0 2.3 0 5.1z"
        />
        <path fill="#CDEFC4" d="M37 0l19 21H42.1c-2.8 0-5.2-2.3-5.2-5.2L37 0z"/>
        <path fill="#22683E" d="M37 15.9v1c0 2.8 2.3 5.2 5.2 5.2H56v-1H42.1c-2.8-.1-5.1-2.4-5.1-5.2z"/>
        <path
            fill="#FFF"
            d="M23.5 46.7h-6.9c-.4 0-.8.3-.8.8s.3.8.8.8h6.9c.4 0 .8-.3.8-.8s-.4-.8-.8-.8zM16.5 41.3h6.9c.4 0 .8-.3.8-.8 0-.4-.3-.8-.8-.8h-6.9c-.4 0-.8.3-.8.8.1.5.4.8.8.8zM14.2 43.2c-.4 0-.8.3-.8.8 0 .4.3.8.8.8h11.5c.4 0 .8-.3.8-.8 0-.4-.3-.8-.8-.8H14.2z"
        />
    ...
    <g v-else-if="id === 'rtf'">
        <path
            d="M5.113.006A5.074 5.074 0 00.039 5.08v53.841a5.073 5.073 0 005.074 5.074h45.774a5.074 5.074 0 005.074-5.074V20.316L37.058.006H5.113z"
            fill-rule="evenodd"
            clip-rule="evenodd"
            fill="#1B96FF"
        />
        ...
        <path
            d="M15.611 48.825l2.575 3.907a.756.756 0 01.108.378c0 .36-.306.72-.738.72a.699.699 0 01-.594-.324l-2.935-4.555h-2.395v4.141a.734.734 0 01-.756.738.73.73 0 01-.738-.738V42.793c0-.594.486-1.081 1.081-1.081h3.745c2.197 0 3.763 1.405 3.763 3.619 0 2.161-1.477 3.35-3.116 3.494zm-3.979-5.78v4.591h3.151c1.422 0 2.395-.954 2.395-2.305 0-1.35-.972-2.287-2.395-2.287h-3.151zm17.463 0h-3.277v10.047a.734.734 0 01-.756.738.73.73 0 01-.738-.738V43.045h-3.259c-.36 0-.648-.288-.648-.684 0-.36.288-.648.648-.648h8.031c.36 0 .648.288.648.685a.647.647 0 01-.649.647zm10.295 0h-5.833v3.871h5.708c.36 0 .648.288.648.685 0 .36-.288.648-.648.648h-5.708v4.843a.734.734 0 01-.756.738.73.73 0 01-.738-.738V42.793c0-.594.486-1.081 1.081-1.081h6.248c.36 0 .648.288.648.685a.648.648 0 01-.65.648z"
            fill="#fff"
        />
    </g>

    <g v-else-if="id === 'slide'">
        <path
            ...
            fill="#0D9DDA"
        />
        <path d="M10.121 34.772v19.09h19.918v-19.09H10.121zM28.226 50.24H11.931V38.396h16.295V50.24z" fill="#fff"/>
        <path
            d="M55.977 20.352v1H43.178s-6.312-1.26-6.129-6.707c0 0 .208 5.707 6.004 5.707h12.924z"
            fill-rule="evenodd"
            clip-rule="evenodd"
    ...
    <g v-else-if="id === 'stypi'" fill-rule="evenodd" clip-rule="evenodd">
        <path
    ...
    <g v-else-if="id === 'txt'">
        ...
        <g fill-rule="evenodd" clip-rule="evenodd">
            <path
                ...
                fill="#E4A201"
            />
            <path d="M37.106-.036v14.561c0 1.656 1.104 5.792 6.104 5.792h12.799L37.106-.036z" fill="#F9E3B6"/>
        </g>
        <path
    ...
    <g v-else-if="id === 'unknown'" fill-rule="evenodd" clip-rule="evenodd">
        <path
    ...
    <g v-else-if="id === 'word'">
        <g fill-rule="evenodd">
            <path
                ...
                fill="#107CAD"
            />
            <path d="M56 20.35v1H43.18s-6.31-1.26-6.13-6.71c0 0 .21 5.71 6 5.71z" fill="#084968"/>
            <path d="M37.07 0v14.56a5.78 5.78 0 006.11 5.79H56z" fill="#90D0FE"/>
        </g>
        <path
