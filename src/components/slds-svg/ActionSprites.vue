...
<template>
    ...
    <symbol viewBox="0 0 24 24" id="add_contact"
    ...
    <symbol viewBox="0 0 24 24" id="add_file"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="add_photo_video"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="add_relationship"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="clone"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="defer"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="dial_in"
        xmlns="http://www.w3.org/2000/svg">
        <g>
            <circle cx="4.615" cy="4.615" r="2.769"/>
    ...
    <symbol viewBox="0 0 24 24" id="edit_groups"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="edit_relationship"
        xmlns="http://www.w3.org/2000/svg">
        <path d="M19.8 19.4h-1.3v-2.8h1.3c.3 0 .5-.2.5-.4v-12c0-.3-.2-.5-.5-.5h-12c-.2 0-.4.2-.4.5v1.3H4.6V4.2C4.6 2.4 6 .9 7.8.9h12c1.8 0 3.3 1.5 3.3 3.3v12c0 1.8-1.5 3.2-3.3 3.2zm-5-12h-12c-1 0-1.9.8-1.9 1.8v12c0 1 .9 1.9 1.9 1.9h12c1 0 1.8-.9 1.8-1.9v-12c0-1-.8-1.8-1.8-1.8zm-8 11.8c-.1 0-.1 0-.2.1l-2.1.5c-.2 0-.3-.1-.3-.3l.5-2.1s.1-.1.1-.2c.1-.1.2-.1.3 0l1.7 1.7c.1.1.1.3 0 .3zm5.1-5.1l-4.3 4.3c-.1.1-.2.1-.3 0l-1.7-1.7c-.1-.1-.1-.2 0-.3l4.3-4.3c.1-.1.2-.1.3 0l1.7 1.7v.3zm1.3-1.3l-.5.4c-.1.1-.2.1-.3 0l-1.7-1.7c-.1-.1-.1-.1 0-.2l.5-.5c.3-.3.8-.3 1.1 0l.9.9c.3.3.3.8 0 1.1z"/>
    </symbol>
    ...
    <symbol viewBox="0 0 24 24" id="follow"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="following"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="freeze_user"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="goal"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="google_news"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="join_group"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="lead_convert"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="leave_group"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="log_event"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="manage_perm_sets"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_case"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_child_case"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_contact"
        xmlns="http://www.w3.org/2000/svg">
        <path d="M21.2 4.2H2.8C1.5 4.2.5 5.2.5 6.5v11c0 1.3 1 2.3 2.3 2.3h18.4c1.3 0 2.3-1 2.3-2.3v-11c0-1.3-1-2.3-2.3-2.3zm-9.8 13H4.8c-.7 0-1.3-.8-1.3-1.6.1-1.2 1.3-1.8 2.5-2.4.9-.4 1-.7 1-1.1 0-.4-.2-.7-.5-1-.5-.5-.8-1.2-.8-1.9 0-1.5.9-2.7 2.4-2.7s2.4 1.3 2.4 2.7c0 .8-.3 1.5-.8 1.9-.3.3-.6.6-.6 1s.1.7 1.1 1.1c1.2.5 2.4 1.2 2.4 2.4.2.8-.4 1.6-1.2 1.6zm9-2.7c0 .4-.3.8-.7.8h-3.5c-.4 0-.8-.3-.8-.8v-1.2c0-.4.4-.7.8-.7h3.5c.4 0 .7.3.7.7v1.2zm0-4.2c0 .4-.3.8-.7.8h-5.8c-.4 0-.7-.3-.7-.8V9.1c0-.4.3-.7.7-.7h5.8c.4 0 .8.3.8.7v1.2z"/>
    </symbol>
    <symbol viewBox="0 0 24 24" id="new_custom1"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom10"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom100"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom11"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom12"
        xmlns="http://www.w3.org/2000/svg">
        <circle cx="12" cy="12" r="11.077"/>
    </symbol>
    <symbol viewBox="0 0 24 24" id="new_custom13"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom14"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom15"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom16"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom17"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom18"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom19"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom21"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom22"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom23"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom24"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom25"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom26"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom27"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom28"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom29"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom3"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom30"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom31"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom32"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom33"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom34"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom35"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom36"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom37"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom38"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom39"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom4"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom40"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom41"
        xmlns="http://www.w3.org/2000/svg">
        <path d="M21 5.1H3c-1.2 0-2.1.9-2.1 2v9.8c0 1.1.9 2 2.1 2h18c1.2 0 2.1-.9 2.1-2V7.1c0-1.1-.9-2-2.1-2zM5.4 16.9c0-1.3-1-2.4-2.4-2.4v-5c1.4 0 2.4-1.1 2.4-2.4h13.2c0 1.3 1.1 2.4 2.4 2.4v5c-1.3 0-2.4 1.1-2.4 2.4H5.4z"/>
        <ellipse cx="12" cy="11.815" rx="3.462" ry="3.369"/>
    </symbol>
    <symbol viewBox="0 0 24 24" id="new_custom42"
        xmlns="http://www.w3.org/2000/svg">
        <path d="M20.9 1.8H3.1C1.9 1.8.9 2.8.9 4v2.2c0 .4.3.7.8.7h20.6c.5 0 .8-.3.8-.7V4c0-1.2-1-2.2-2.2-2.2zm0 7.3H3.1c-.4 0-.7.3-.7.7V20c0 1.2 1 2.2 2.2 2.2h14.8c1.2 0 2.2-1 2.2-2.2V9.8c0-.4-.3-.7-.7-.7zm-4.8 3.3c0 .6-.5 1.1-1.1 1.1H9c-.6 0-1.1-.5-1.1-1.1 0-.6.5-1.1 1.1-1.1h6c.6 0 1.1.4 1.1 1.1z"/>
    </symbol>
    <symbol viewBox="0 0 24 24" id="new_custom43"
        xmlns="http://www.w3.org/2000/svg">
        <path d="M23 9.8v-.7V9c0-.1 0 0-.1 0v-.1c0-.1-.1 0-.1 0l-4-5.7c-.2-.2-.4-.4-.8-.4H6c-.4 0-.7.2-.9.4l-4 5.6c0 .1-.1.1-.1.1V9c0 .1 0 0-.1 0V9.8c.1 0 .1.1.1.1v.1h.1l10.1 10.9v.1h.1s.1 0 .1.1v.1h.1v.1h.8v-.1h.1v-.1h.1V21h.1v-.1h.1L22.8 10v-.1h.1l.1-.1zM12 8.4h-1.6L12 5.7l1.6 2.7H12zm0 2h2l-2 6.5-2-6.5h2zm1.8-5.6h2.5l-.9 2.6-1.6-2.6zM8.7 7.4l-.9-2.6h2.5L8.7 7.4zm-.8 3l1.8 6-5.5-6h3.7zm8.2 0h3.7l-5.5 6 1.8-6zm4-2h-3l1-2.8 2 2.8zM5.9 5.6l1 2.8h-3l2-2.8z"/>
    </symbol>
    <symbol viewBox="0 0 24 24" id="new_custom44"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom45"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom46"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom47"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom48"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom49"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom5"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom50"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom51"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom52"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom53"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom54"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom55"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom56"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom57"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom58"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom59"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom61"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom62"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom63"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom64"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom65"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom66"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom67"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom68"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom69"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom71"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom72"
        xmlns="http://www.w3.org/2000/svg">
        <g>
            <path d="M22 .9H2C1.4.9.9 1.4.9 2S1.4 3.1 2 3.1h8.9v2.3c-4 .6-7 3.9-7 8V16c0 2.6 2.1 4.9 4.9 4.9h6.5c2.7 0 4.9-2.2 4.9-4.9v-2.6c0-4.1-3.1-7.5-7-8V3.1H22c.7 0 1.1-.4 1.1-1.1S22.6.9 22 .9zm-4.8 12.5c0 1-.9 1.9-2 1.9H8.8c-1.1 0-1.9-.8-2-1.9.1-2.8 2.3-5.1 5.1-5.1h.1c2.9 0 5.1 2.3 5.2 5.1z"/>
            <circle cx="3.138" cy="21.6" r="1.477"/>
            <circle cx="20.862" cy="21.6" r="1.477"/>
        </g>
    </symbol>
    <symbol viewBox="0 0 24 24" id="new_custom73"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom74"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom75"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom76"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom77"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom78"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom79"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom81"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom82"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom83"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom84"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom85"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom86"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom87"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom88"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom89"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom9"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom90"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom91"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom92"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom93"
        xmlns="http://www.w3.org/2000/svg">
        <g>
            <path d="M9.3 12h11c.3 0 .7-.2.7-.6l2-6.8c.2-.5-.2-1-.7-1h-17l-.3-1c-.2-.4-.6-.8-1.1-.8H2.1c-.6 0-1.1.5-1.2 1.1C.9 3.5 1.4 4 2 4h1.1l3.5 11.6c.1.4.6.7 1.1.7h13c.6 0 1.1-.4 1.2-1 0-.6-.5-1.1-1.1-1.1H9.3c-.5 0-.9-.4-1-.8-.3-.7.3-1.4 1-1.4z"/>
            <ellipse cx="9.508" cy="20.354" rx="1.846" ry="1.8"/>
            <ellipse cx="18.508" cy="20.354" rx="1.846" ry="1.8"/>
        </g>
    </symbol>
    <symbol viewBox="0 0 24 24" id="new_custom94"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom95"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom96"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom97"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_custom98"
        xmlns="http://www.w3.org/2000/svg">
        <g>
            <path d="M22.9 10.2l-2.7-2.7c-.2-.2-.4-.3-.5-.3h-2.8c-.4 0-.7.4-.7.7v5.6c0 .3.2.4.5.3.5-.2 1-.3 1.6-.3 1.5 0 2.9.9 3.6 2.2.1.2.4.2.5.1.4-.4.7-.9.7-1.6v-3.5c0-.2-.1-.4-.2-.5z"/>
            <ellipse cx="18.231" cy="17.769" rx="2.077" ry="2.077"/>
            <path d="M13.4 4.2H1.6c-.4 0-.7.3-.7.6v9.5c0 .6.3 1.2.7 1.5.2.2.4.1.5-.1.7-1.3 2.1-2.1 3.7-2.1 1.7 0 3.2 1 3.8 2.6 0 .1.2.2.3.2H12c1.2 0 2.1-.9 2.1-2.1V4.8c0-.3-.3-.6-.7-.6z"/>
            <ellipse cx="5.769" cy="17.769" rx="2.077" ry="2.077"/>
        </g>
    </symbol>
    <symbol viewBox="0 0 24 24" id="new_custom99"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_event"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_group"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_lead"
        xmlns="http://www.w3.org/2000/svg">
        <circle cx="12" cy="4.246" r="3.323"/>
        <path d="M22.3 9.8H1.7c-.8 0-1.1.9-.5 1.3l5.4 3.5c.3.2.5.5.3.8l-2 6.8c-.2.7.8 1.2 1.3.6l5.3-5.5c.3-.3.8-.3 1.1 0l5.3 5.5c.5.6 1.4.1 1.3-.6l-2.1-6.8c-.1-.3 0-.7.3-.9l5.4-3.4c.6-.4.3-1.3-.5-1.3z"/>
    </symbol>
    <symbol viewBox="0 0 24 24" id="new_note"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_notebook"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="new_opportunity"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="password_unlock"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="question_post_action"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="recall"
        xmlns="http://www.w3.org/2000/svg">
        <path d="M8.4 10.4c-.2-.2-.1-.7.2-.8h4.2c3.1 0 5.6 2.6 5.3 5.8-.3 2.7-2.7 4.8-5.5 4.8h-1.5c-.4 0-.8.3-.8.7v1.4c0 .4.4.8.8.8h1.6c4.5 0 8.1-3.6 8.2-8.1.1-4.5-3.8-8.3-8.3-8.3H8.7s-1.2 0-.4-.8L11 3.2c.3-.3.3-.8 0-1l-1-1c-.3-.3-.8-.3-1 0L2.5 7.7c-.3.2-.3.7 0 1L9 15.2c.3.3.7.3 1 0l1-1c.3-.3.3-.8 0-1l-2.6-2.8z"/>
    </symbol>
    ...
    <symbol viewBox="0 0 24 24" id="reject"
        xmlns="http://www.w3.org/2000/svg">
        <path d="M14.6 11.9l6-6c.3-.3.3-.7 0-1l-.9-1c-.3-.3-.7-.3-1 0L12.6 10c-.1.2-.4.2-.6 0L6 3.9c-.3-.3-.7-.3-1 0l-1 .9c-.3.3-.3.7 0 1l6.1 6.1c.1.1.1.4 0 .6L4 18.6c-.3.3-.3.7 0 1l.9.9c.3.3.7.3 1 0l6.1-6c.2-.2.5-.2.6 0l6.1 6c.3.3.7.3 1 0l.9-.9c.3-.3.3-.7 0-1l-6-6c-.2-.2-.2-.5 0-.7z"/>
    </symbol>
    ...
    <symbol viewBox="0 0 24 24" id="remove_relationship"
        xmlns="http://www.w3.org/2000/svg">
        <path d="M16.6 9.2c0-1-.8-1.8-1.8-1.8h-12c-1 0-1.9.8-1.9 1.8v12c0 1 .9 1.9 1.9 1.9h12c1 0 1.8-.9 1.8-1.9v-12zm-11.5 7c-.3 0-.5-.3-.5-.5v-.9c0-.3.2-.5.5-.5h7.4c.2 0 .4.2.4.5v.9c0 .2-.2.5-.4.5H5.1zm14.7 3.2h-1.3v-2.8h1.3c.3 0 .5-.2.5-.4v-12c0-.3-.2-.5-.5-.5h-12c-.2 0-.4.2-.4.5v1.3H4.6V4.2C4.6 2.4 6 .9 7.8.9h12c1.8 0 3.3 1.5 3.3 3.3v12c0 1.8-1.5 3.2-3.3 3.2z"/>
    </symbol>
    <symbol viewBox="0 0 24 24" id="reset_password"
        xmlns="http://www.w3.org/2000/svg">
        <path d="M21.5 1.8h-1.4c-.4 0-.7.4-.7.7v3.3c0 .4-.2.6-.6.3-.1-.2-.2-.3-.4-.5-2.3-2.3-5.6-3.2-8.9-2.6-1.1.2-2.3.7-3.2 1.3-2.8 1.9-4.5 4.9-4.5 8.1 0 2.5.9 5 2.7 6.8 1.8 1.9 4.3 3 7 3 2.3 0 4.6-.8 6.3-2.3.3-.3.3-.7.1-1l-1-1c-.2-.2-.7-.3-.9 0-1.7 1.3-4 1.9-6.2 1.3-.6-.1-1.2-.4-1.8-.7-2.6-1.6-3.8-4.7-3.1-7.7.1-.6.4-1.2.7-1.8 1.3-2.2 3.6-3.5 6-3.5 1.8 0 3.6.8 4.9 2.1.2.2.4.4.5.6.2.4-.2.6-.6.6h-3.2c-.4 0-.7.3-.7.7v1.4c0 .4.3.6.7.6h8.4c.3 0 .6-.2.6-.6V2.5c0-.3-.4-.7-.7-.7z"/>
    </symbol>
    <symbol viewBox="0 0 24 24" id="script"
        xmlns="http://www.w3.org/2000/svg">
        <path d="M20.3 3.1c-4.1 0-7.2 3.2-7.2 7.3v9.7c0 .4.3.7.7.7h7.7c.4 0 .7-.3.7-.7v-7.6c0-.4-.3-.7-.7-.7h-5.7v-1.4c0-2.2 2.2-4.5 4.5-4.5h1.2c.3 0 .7-.3.7-.7V3.8c0-.3-.4-.7-.7-.7h-1.2zM9 3.1c-4 0-7.2 3.2-7.2 7.3v9.8c0 .3.4.7.7.7h7.7c.4 0 .7-.4.7-.7v-7.7c0-.4-.3-.7-.7-.7H4.6v-1.4c0-2.2 2.2-4.5 4.4-4.5h1.2c.4 0 .7-.3.7-.7V3.8c0-.3-.3-.7-.7-.7H9z"/>
    </symbol>
    ...
    <symbol viewBox="0 0 24 24" id="share_link"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="share_poll"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="share_thanks"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="submit_for_approval"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="update_status"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="user_activation"
        xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="view_relationship"
        xmlns="http://www.w3.org/2000/svg">
        <path d="M16.6 9.2c0-1-.8-1.8-1.8-1.8h-12c-1 0-1.9.8-1.9 1.8v12c0 1 .9 1.9 1.9 1.9h12c1 0 1.8-.9 1.8-1.9v-12zm3.2 10.2h-1.3v-2.8h1.3c.3 0 .5-.2.5-.4v-12c0-.3-.2-.5-.5-.5h-12c-.2 0-.4.2-.4.5v1.3H4.6V4.2C4.6 2.4 6 .9 7.8.9h12c1.8 0 3.3 1.5 3.3 3.3v12c0 1.8-1.5 3.2-3.3 3.2z"/>
    </symbol>
    <symbol viewBox="0 0 24 24" id="web_link"
        xmlns="http://www.w3.org/2000/svg">
