<template>
    <div class="slds-virtual-table-container">
        ...
        <div class="slds-virtual-table">
            ...
            <!-- Body - No single file components inside RecycleScroller due to performance restrictions. -->
            <recycle-scroller
                ...
                <template v-slot="{ item, index }">
                    <div class="slds-virtual-table_row" :class="{selected: item.isSelected}" :style="{ width: `${rowWidth}px` }">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            hasCheckboxColumn() {
                console.log('hasCheckboxColumn')
                return this.rows.some(row => row.isSelected in row);
            },
        },
        watch: {
            filter() {
