    ...
    <div class="slds-form-element">
        ...
        <div class="slds-form-element__control">
            ...
            >
                ...
                <div
                    ref="editorElement"
                    class="slds-rich-text-editor__output slds-grid"
                    :style="editorStyle"
                />
                ...
                <div
                    ...
                    ref="toolbarElement"
                    role="toolbar"
                    class="slds-rich-text-editor__toolbar slds-shrink-none slds-rich-text-editor__toolbar_bottom"
                >
                    <slot name="toolbar">
                        <slds-rich-text-toolbar
                            background-color-picker
...
import SldsRichTextToolbar from '@/components/slds-rich-text-editor/slds-rich-text-toolbar'
        ...
        this.quill = new Quill(this.$refs.editorElement, {
            modules: {
                ...
                history: {
                    ...
                    maxStack: this.historyMaxStack,
                    userOnly: this.historyUserOnly
                },
                syntax: this.syntaxHighlighter
            },
